							...
							<form id="meetingForm"
								...
								<div class="row gy-2 overflow-hidden">
									...
									<div class="col-md-6">
										<div class="form-floating mb-3">
											<input type="text" class="form-control" name="meetingByUser"
												...
												value="${sessionScope.fullname}" readonly> <label
												for="meetingByUser" class="form-label"
									...
									<div class="col-md-6">
										...
										<div id="startTimeError" class="text-danger"style="font-weight: bold;background: white;
									...
									<div class="col-md-6">
										...
										<div id="endTimeError" class="text-danger"style="font-weight: bold;background: white;
										border-radius: 4px;"></div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-floating mb-3">
											<textarea class="form-control" name="meetingPurpose"
												id="meetingPurpose"
												style="color: black; font-family: 'Rubik', cursive;"
												rows="3" oninput="validatePurpose()" required></textarea>
											<label for="meetingPurpose" class="form-label"
												style="color: black; font-family: 'Rubik', cursive;">Meeting
												Purpose<span class="required-asterisk">*</span>
											</label>
										</div>
										<div id="purposeError" class="text-danger"style="font-weight: bold;background: white;
										border-radius: 4px;"></div>
									</div>
									...
									<div class="col-md-6">
										...
										<div id="statusError" class="text-danger"style="font-weight: bold;background: white;
										border-radius: 4px;"></div>
									</div>
									...
									<div class="col-md-6">
										...
										<div id="roomError" class="text-danger"style="font-weight: bold;background: white;
										border-radius: 4px;"></div>
									</div>
											...
											<div class="form-control-wrapper">
												...
												<div class="form-floating col-md-12 mb-3">
													<input type="text" id="searchParticipants"
														...
														for="searchParticipants" class="form-label" style="color: black;">Search
														Participants</label>
												</div>
												...
												<div class="form-control" id="participants"
													...
													<c:forEach var="user" items="${userList}">
														<div class="form-check participant-item">
															<input class="form-check-input" type="checkbox"
																name="participants" id="${user.userFullname}"
																value="${user.userFullname}"> <label
																class="form-check-label" for="${user.userFullname}"
																style="color: black; font-family: 'Rubik', cursive;">
																${user.userFullname} </label>
														</div>
													</c:forEach>
												</div>
												<div id="participantsError" class="text-danger"style="font-weight: bold;background: white;
										border-radius: 4px;margin-top: 5px;"></div>
											</div>
										</div>
									</div>
