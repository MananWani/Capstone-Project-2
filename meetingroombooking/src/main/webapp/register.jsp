					...
					<div class="card rounded-3 shadow-sm"
						...
						<div class="card-body p-3 p-md-4 p-xl-5">
							...
							<h4 class="text-center mb-4"
								style="color: white; margin-bottom: 10px; font-family: 'Rubik', cursive;">Register</h4>
									...
									<div class="col-12">
										<div class="form-floating mb-3">
											<input type="text" class="form-control" name="userFullname"
												...
												style="color: black; font-family: 'Rubik', cursive;">Fullname<span
									...
									<div class="col-12">
										<div class="form-floating mb-3">
											<input type="email" class="form-control" name="userEmail"
												id="userEmail" style="color: black;"
												oninput="validateEmail()" required> <label
												for="userEmail" class="form-label"
												style="color: black; font-family: 'Rubik', cursive;">Email<span
												class="required-asterisk">*</span></label>
										</div>
										<div id="emailError" class="text-danger"style="font-weight: bold;background: white;border-radius: 4px;"></div>
									</div>
									<div class="col-12">
										<div class="form-floating mb-3">
											<input type="text" class="form-control" name="userMobileNo"
												id="userMobileNo" style="color: black;"
												oninput="validateMobile()" required> <label
												for="userMobileNo" class="form-label"
												style="color: black; font-family: 'Rubik', cursive;">Mobile
												Number<span class="required-asterisk">*</span>
											</label>
										</div>
										<div id="mobileError" class="text-danger"style="font-weight: bold;background: white;border-radius: 4px;"></div>
									</div>
									<div class="col-12">
										<div class="form-floating mb-3">
											<select class="form-select" name="userDesignation"
												...
												style="color: black; font-family: 'Rubik', cursive;">Designation<span
												class="required-asterisk">*</span></label>
										</div>
										<div id="designationError" class="text-danger"style="font-weight: bold;background: white;border-radius: 4px;"></div>
									</div>
									...
									<div class="col-12">
										<div class="form-floating mb-3 password-container"
											...
											<input type="password" class="form-control"
												...
												oninput="validatePassword()" required> <label
												for="userPassword" class="form-label"
												style="color: black; font-family: 'Rubik', cursive;">Password<span
												class="required-asterisk">*</span></label> <i
												class="fas fa-eye eye-icon" id="togglePassword"></i>
										</div>
										<div id="passwordError" class="text-danger" 
											style="margin-top: 2px;font-weight: bold;background: white;border-radius: 4px;"></div>
									</div>
									<div class="col-12">
										<div class="form-floating mb-3">
											<select class="form-select" name="userUnderManager"
												...
												<c:forEach var="user" items="${managerList}">
													<option value="${user.userFullname}">${user.userFullname}</option>
												</c:forEach>
											</select> <label for="userUnderManager" class="form-label"
												style="color: black; font-family: 'Rubik', cursive;">Under
												Manager<span class="required-asterisk">*</span>
											</label>
										</div>
										<div id="managerError" class="text-danger"style="font-weight: bold;background: white;border-radius: 4px;"></div>
									</div>
									<div class="col-12">
										<div class="form-check mb-3">
											<input type="checkbox" class="form-check-input"
												name="userActive" id="userActive"> <label
												for="userActive" class="form-check-label"
												style="color: white; font-family: 'Rubik', cursive;">Active</label>
										</div>
									</div>
									...
									<div class="col-12">
										<div class="d-grid my-3">
											<button class="btn1" type="submit" id="registerButton"
												...
												margin-left:47px;font-family: 'Rubik', cursive;">Register</button>
										</div>
									</div>
