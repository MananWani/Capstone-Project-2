					...
					<div class="card rounded-3 shadow-sm"
						...
						<div class="card-body p-3 p-md-4 p-xl-5">
							...
							<h4 class="text-center mb-4"
								style="color: white; margin-bottom: 10px; font-family: 'Rubik', cursive;">Update
								Meeting Room</h4>
							...
							<form id="registerForm"
								action="${pageContext.request.contextPath}/meetingroom/updateroom"
								method="post">
									...
									<div class="col-12">
										<div class="form-floating mb-3">
											<input type="text" class="form-control" name="roomName"
												...
												value="${room.roomName }" oninput="validateRoomName()"
												required> <label for="roomName" class="form-label"
												style="color: black; font-family: 'Rubik', cursive;">
												Room Name<span class="required-asterisk">*</span>
											</label>
										</div>
										<div id="nameError" class="text-danger"style="font-weight: bold;background: white;
									...
									<div class="col-12">
										<div class="form-floating mb-3">
											<input type="number" class="form-control" name="roomCapacity"
												...
												value="${room.roomCapacity }" oninput="validateCapacity()"
												required> <label for="roomCapacity"
												class="form-label"
												style="color: black; font-family: 'Rubik', cursive;">
									...
									<div class="col-12">
										...
										<div class="form-check">
											<input class="form-check-input" type="checkbox"
												...
												${fn:contains(equipments, 'Projector') ? 'checked' : ''}>
										...
										<div class="form-check">
											<input class="form-check-input" type="checkbox"
												...
												${fn:contains(equipments, 'Whiteboard') ? 'checked' : ''}>
										...
										<div class="form-check">
											<input class="form-check-input" type="checkbox"
												...
												${fn:contains(equipments, 'Smartboard') ? 'checked' : ''}>
										...
										<div class="form-check">
											<input class="form-check-input" type="checkbox"
												...
												id="chargingStations"
												${fn:contains(equipments, 'Charging Stations') ? 'checked' : ''}>
											<label class="form-check-label" for="chargingStations"
												style="color: white; font-family: 'Rubik', cursive;">
