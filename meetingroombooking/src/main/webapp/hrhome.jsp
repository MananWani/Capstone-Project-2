...
<body>
	...
	<section class="main"
		...
		<div class="welcome-message" style="background: rgba(255, 255, 255, 0.3);">
			<h1>
				Welcome,
			...
			<p>Your go-to platform for booking meeting rooms seamlessly.
				</p>
		</div>
	</section>
	<section class="section">
		<div class="container">
			<div class="cover">
			<h3 style="font-family: 'Rubik', cursive; font-weight: bold;"
								>Meeting Rooms</h3>
					...
					<div class="modal-content">
						...
						<div class="modal-footer">
							<form
								...
								method="get">
								<button type="submit"class="btn0" style="margin-right: 260px; width: 200px;"
									>Schedule
									Meeting</button>
						</form></div>
					</div>
