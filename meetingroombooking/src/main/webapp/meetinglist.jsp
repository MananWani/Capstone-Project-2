...
<body>
	...
	<section class="employees" id="employees">
		<div class="container py-4">
			<h2 class="text-center mb-4"style="font-family: 'Rubik', cursive;">My Meetings</h2>
										...
										<tbody>
											<c:forEach var="meeting" items="${meetingList}">
												...
												<tr style="font-family: 'Rubik', cursive;">
													...
													<c:if test="${meeting.meetingStatus eq 'Scheduled' && meeting.meetingByUser.userFullname == sessionScope.fullname}">
