	...
	<section class="employees" id="employees">
		<div class="container py-4">
								...
								<div class="col-md-6 mb-3">
									<div class="form-floating col-md-10">
										<input type="text" class="form-control" id="searchInput"
											onkeyup="searchTable()" style="width: 100%;color: black;"> <label
											for="searchInput" class="form-label" style="color: black;">Search employee</label>
									</div>
								</div>
									...
									<table class="table table-bordered">
										<thead>
											<tr style="font-family: 'Rubik', cursive;">
												...
												<th style="width: 500px;">Working Under Manager</th>
										...
										<tbody>
											<c:forEach var="user" items="${userList}">
												...
												<tr style="font-family: 'Rubik', cursive;">
													<td style="width: 150px;">${user.userFullname}</td>
													<td>${user.userDesignation}</td>
													<td>${user.userEmail}</td>
													<td style="width: 250px;">${user.userMobileNo}</td>
													<td style="width: 500px;">${user.userUnderManager}</td>
													<td style="width: 100px;">${user.userActive ? 'Active' : 'Inactive'}</td>
			...
			<c:if test="${empty userList}">
				<p class="text-center" style="font-family: 'Rubik', cursive;">No
					employee found.</p>
			</c:if>
		</div>
	</section>
